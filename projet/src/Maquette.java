...
public class Maquette extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        appliquerBruitage.setOnAction(e -> {
        	try {
				Main.principal(path, sigma);
			} catch (Exception e1) {
				// TODO Auto-generated catch block
				e1.printStackTrace();
			}
        	imageBruitee.setImage(new Image("file:/home/cytech/Java/javafx/projet/images/bruitees/image_noisy_sigma" + sigma + ".png"));
        ...
        imageContainer.getChildren().addAll(
                ...
                createDynamicImageBox("Image bruitée", "Bruitée (σ=" + sigma + ")"),
